...
| --- | --- | --- | --- | --- | --- |
| A00 | TODO | `feature/platform-foundation` | Docker Compose、Django health、FastAPI health、Next.js shell、Redis、Postgres、基础环境变量 | 无 | 三端服务可启动 |
| A01 | TODO | `feature/contracts-v1` | OpenAPI、JSON Schema、Mock 示例、错误结构 | A00 | `contracts/` 校验通过 |
