...
class Settings:
    ...
    siliconflow_connect_timeout: float
    siliconflow_read_timeout: float
    ai_log_stages: bool
...
settings = Settings(
    ...
    ai_model=os.getenv("AI_MODEL", os.getenv("SILICONFLOW_CHAT_MODEL", "mock-reviewer")),
    ...
    siliconflow_connect_timeout=float(os.getenv("SILICONFLOW_CONNECT_TIMEOUT", "10")),
    siliconflow_read_timeout=float(os.getenv("SILICONFLOW_READ_TIMEOUT", "180")),
    ai_log_stages=_env_bool("AI_LOG_STAGES", "true"),
)
