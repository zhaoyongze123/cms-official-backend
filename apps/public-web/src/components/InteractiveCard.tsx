...
export const InteractiveCard = ({ articles }: InteractiveCardProps) => {
  ...
  return (
    <div className="relative w-full h-[550px] flex items-center justify-center perspective-2000">
      <div className="relative w-full max-w-md h-full group">
        <AnimatePresence mode="popLayout" custom={direction} initial={false}>
          ...
          >
            <Link
              ...
              className="block w-full h-full bg-white rounded-[3rem] shadow-2xl border border-line overflow-hidden group-hover:border-hermes/30 transition-colors duration-500"
            >
                ...
                <div className="flex-1 p-8 flex flex-col justify-between bg-white relative">
                  ...
                  <div className="flex items-center justify-between pt-6">
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-2 bg-mist rounded-full hover:bg-hermes hover:text-white transition-all duration-300"
                    >
